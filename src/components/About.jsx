            ...
            {activeTab === 'about' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <ContactItem icon={<Mail className="text-pink-500" />} text="ayushchahal44@gmail.com" />
                  <ContactItem icon={<Phone className="text-pink-500" />} text="+919760203187" />
                  <ContactItem icon={<Github className="text-pink-500" />} text="github.com/ayushchahal44" />
                  <ContactItem icon={<Linkedin className="text-pink-500" />} text="linkedin.com/in/ayush-chahal" />
                </div>
              </div>
            )}
